...
from strategy import Problem3Strategy, parse_channels


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the baseline Problem 3 search-and-clear strategy.")
...
def main() -> int:
    ...
    strategy = Problem3Strategy(channels=parse_channels(args.channels))
