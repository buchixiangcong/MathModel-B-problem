...
def strategy_config(fast: bool) -> StrategyConfig:
    if fast:
        # Keep the reduced localization search, but retain the 31-point
        # outer lattice so fast mode has the same direction-independent
        # discovery coverage as the strict configuration.
        return StrategyConfig(lattice_margin=1000.0, strict_discovery_certificate=True,
                              ...
                              bootstrap_observation_target=3)
